  ...
  return (
    <div className="flex items-center gap-2 ">
      ...
      >
        ...
        />
        <div className="w-5 h-5 bg-white border-[2px] border-gray-100 peer-focus:outline-hidden peer-active:outline-hidden rounded-full peer-checked:bg-em-blue transition-all duration-75 peer-checked:border-em-blue flex items-center justify-center ">
          <svg
